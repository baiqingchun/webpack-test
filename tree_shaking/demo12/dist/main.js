!function (n) {
    ...
    (function (n, e) {
         ...
         */(function () {
            var i, o = 200, f = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.",
                ...
                h = 1, p = 2, v = 4, _ = 1, g = 2, y = 1, d = 2, b = 4, w = 8, m = 16, x = 32, j = 64, A = 128, O = 256,
                k = 512, E = 30, I = "...", R = 800, S = 16, z = 1, L = 2, W = 1 / 0, C = 9007199254740991,
                T = 17976931348623157e292, U = NaN, B = 4294967295, $ = B - 1, P = B >>> 1,
                D = [["ary", A], ["bind", y], ["bindKey", d], ["curry", w], ["curryRight", m], ["flip", k], ["partial", x], ["partialRight", j], ["rearg", O]],
                M = "[object Arguments]", F = "[object Array]", N = "[object AsyncFunction]", q = "[object Boolean]",
                Z = "[object Date]", K = "[object DOMException]", V = "[object Error]", G = "[object Function]",
                ...
                sn = "[object Float32Array]", hn = "[object Float64Array]", pn = "[object Int8Array]",
                vn = "[object Int16Array]", _n = "[object Int32Array]", gn = "[object Uint8Array]",
                yn = "[object Uint8ClampedArray]", dn = "[object Uint16Array]", bn = "[object Uint32Array]",
                wn = /\b__p \+= '';/g, mn = /\b(__p \+=) '' \+/g, xn = /(__e\(.*?\)|\b__t\)) \+\n'';/g,
                jn = /&(?:amp|lt|gt|quot|#39);/g, An = /[&<>"']/g, On = RegExp(jn.source), kn = RegExp(An.source),
                En = /<%-([\s\S]+?)%>/g, In = /<%([\s\S]+?)%>/g, Rn = /<%=([\s\S]+?)%>/g,
                Sn = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, zn = /^\w*$/,
                Ln = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
                Wn = /[\\^$.*+?()[\]{}|]/g, Cn = RegExp(Wn.source), Tn = /^\s+|\s+$/g, Un = /^\s+/, Bn = /\s+$/,
                $n = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, Pn = /\{\n\/\* \[wrapped with (.+)\] \*/,
                Dn = /,? & /, Mn = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, Fn = /\\(\\)?/g,
                Nn = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, qn = /\w*$/, Zn = /^[-+]0x[0-9a-f]+$/i, Kn = /^0b[01]+$/i,
                Vn = /^\[object .+?Constructor\]$/, Gn = /^0o[0-7]+$/i, Hn = /^(?:0|[1-9]\d*)$/,
                ...
                at = "\\ud83c[\\udffb-\\udfff]", ct = "[^\\ud800-\\udfff]", lt = "(?:\\ud83c[\\udde6-\\uddff]){2}",
                st = "[\\ud800-\\udbff][\\udc00-\\udfff]", ht = "[A-Z\\xc0-\\xd6\\xd8-\\xde]",
                pt = "(?:" + ot + "|" + ft + ")", vt = "(?:" + ht + "|" + ft + ")",
                _t = "(?:" + et + "|" + at + ")" + "?",
                gt = "[\\ufe0e\\ufe0f]?" + _t + ("(?:\\u200d(?:" + [ct, lt, st].join("|") + ")[\\ufe0e\\ufe0f]?" + _t + ")*"),
                yt = "(?:" + [it, lt, st].join("|") + ")" + gt,
                dt = "(?:" + [ct + et + "?", et, lt, st, tt].join("|") + ")", bt = RegExp("['’]", "g"),
                wt = RegExp(et, "g"), mt = RegExp(at + "(?=" + at + ")|" + dt + gt, "g"),
            ...
            var Rt = {"\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029"},
                St = parseFloat, zt = parseInt, Lt = "object" == typeof n && n && n.Object === Object && n,
                Wt = "object" == typeof self && self && self.Object === Object && self,
                Ct = Lt || Wt || Function("return this")(), Tt = t && !t.nodeType && t,
                Ut = Tt && "object" == typeof e && e && !e.nodeType && e, Bt = Ut && Ut.exports === Tt,
                $t = Bt && Lt.process, Pt = function () {
                    try {
                        var n = Ut && Ut.require && Ut.require("util").types;
                        return n || $t && $t.binding && $t.binding("util")
                    } catch (n) {
                    }
                }(), Dt = Pt && Pt.isArrayBuffer, Mt = Pt && Pt.isDate, Ft = Pt && Pt.isMap, Nt = Pt && Pt.isRegExp,
                qt = Pt && Pt.isSet, Zt = Pt && Pt.isTypedArray;
            ...
            var Cr = function n(t) {
                var r, e = (t = null == t ? Ct : Cr.defaults(Ct.Object(), t, Cr.pick(Ct, Ot))).Array, u = t.Date,
                    ...
                    ct = t["__core-js_shared__"], lt = ft.toString, st = at.hasOwnProperty, ht = 0,
                    ...
                    dt = Bt ? t.Buffer : i, mt = t.Symbol, jt = t.Uint8Array, Rt = dt ? dt.allocUnsafe : i,
                    Lt = Er(rt.getPrototypeOf, rt), Wt = rt.create, Tt = at.propertyIsEnumerable, Ut = ot.splice,
                    $t = mt ? mt.isConcatSpreadable : i, Pt = mt ? mt.iterator : i, ir = mt ? mt.toStringTag : i,
                    pr = function () {
                        try {
                    ...
                    Ur = u && u.now !== Ct.Date.now && u.now, Br = t.setTimeout !== Ct.setTimeout && t.setTimeout,
                    $r = tt.ceil, Pr = tt.floor, Dr = rt.getOwnPropertySymbols, Mr = dt ? dt.isBuffer : i,
                    Fr = t.isFinite, Nr = ot.join, qr = Er(rt.keys, rt), Zr = tt.max, Kr = tt.min, Vr = u.now,
                    Gr = t.parseInt, Hr = tt.random, Jr = ot.reverse, Yr = $i(t, "DataView"), Qr = $i(t, "Map"),
                    Xr = $i(t, "Promise"), ne = $i(t, "Set"), te = $i(t, "WeakMap"), re = $i(rt, "create"),
                    ee = te && new te, ue = {}, ie = lo(Yr), oe = lo(Qr), fe = lo(Xr), ae = lo(ne), ce = lo(te),
                    le = mt ? mt.prototype : i, se = le ? le.valueOf : i, he = le ? le.toString : i;
                ...
                function je(n, t) {
                    var r = df(n), e = !r && yf(n), u = !r && !e && xf(n), i = !r && !e && !u && Bf(n),
                ...
                function Te(n, t, r, e, u, o) {
                    ...
                    if (s) {
                        if (f = function (n) {
                            ...
                            t && "string" == typeof n[0] && st.call(n, "index") && (r.index = n.index, r.input = n.input);
                            return r
                        }(n), !a) return ri(n, f)
                    } else {
                        var _ = Mi(n), g = _ == G || _ == H;
                ...
                pe.templateSettings = {
                    ...
                    var r = this.__data__, e = Re(r, n);
                    return e < 0 ? (++this.size, r.push([n, t])) : r[e][1] = t, this
                }, we.prototype.clear = function () {
                    this.size = 0, this.__data__ = {hash: new de, map: new (Qr || be), string: new de}
                ...
                function iu(n, t, r, e, u) {
                    return n === t || (null == n || null == t || !Rf(n) && !Rf(t) ? n != n && t != t : function (n, t, r, e, u, o) {
                        var f = df(n), a = df(t), c = f ? F : Mi(n), l = a ? F : Mi(t), s = (c = c == M ? X : c) == X,
                            h = (l = l == M ? X : l) == X, p = c == l;
                        if (p && xf(n)) {
                            if (!xf(t)) return !1;
                            f = !0, s = !1
                        ...
                        if (!(r & _)) {
                            var v = s && st.call(n, "__wrapped__"), y = h && st.call(t, "__wrapped__");
                            if (v || y) {
                                var d = v ? n.value() : n, b = y ? t.value() : t;
                                return o || (o = new xe), u(d, b, r, e, o)
                            }
                        }
                        if (!p) return !1;
                        return o || (o = new xe), function (n, t, r, e, u, o) {
                            var f = r & _, a = Si(n), c = a.length, l = Si(t).length;
                            if (c != l && !f) return !1;
                            var s = c;
                            for (; s--;) {
                                var h = a[s];
                ...
                function _u(n, t, r, e, u) {
                    n !== t && Ze(t, function (o, f) {
                        if (u || (u = new xe), If(o)) !function (n, t, r, e, u, o, f) {
                            ...
                            if (h) {
                                var p = df(c), v = !p && xf(c), _ = !p && !v && Bf(c);
                ...
                function yu(n, t, r) {
                    var e = -1;
                    return t = nr(t.length ? t : [za], yr(Ti())), function (n, t) {
                        var r = n.length;
                ...
                function bu(n, t, r, e) {
                    ...
                    for (n === t && (t = ri(t)), r && (f = nr(n, yr(r))); ++i < o;) for (var a = 0, c = t[i], l = r ? r(c) : c; (a = u(f, l, a, e)) > -1;) f !== n && Ut.call(f, a, 1), Ut.call(n, a, 1);
                    return n
                }
                ...
                var Eu = ee ? function (n, t) {
                    return ee.set(n, t), n
                } : za, Iu = pr ? function (n, t) {
                    return pr(n, "toString", {configurable: !0, enumerable: !1, value: Ia(t), writable: !0})
                } : za;
                ...
                function Wu(n, t, r, e) {
                    ...
                    for (var u = 0, o = null == n ? 0 : n.length, f = t != t, a = null === t, c = Uf(t), l = t === i; u < o;) {
                        var s = Pr((u + o) / 2), h = r(n[s]), p = h !== i, v = null === h, _ = h == h, g = Uf(h);
                ...
                function Fu(n, t, r) {
                    ...
                    for (var i = -1, o = e(u); ++i < u;) for (var f = n[i], a = -1; ++a < u;) a != i && (o[i] = $e(o[i] || f, n[a], t, r));
                ...
                function Ju(n, t) {
                    if (t) return n.slice();
                    var r = n.length, e = Rt ? Rt(r) : new n.constructor(r);
                    return n.copy(e), e
                }
                ...
                function ai(n) {
                    return function (t) {
                        var r = Or(t = Kf(t)) ? Lr(t) : i, e = r ? r[0] : t.charAt(0),
                ...
                function hi(n) {
                    return Ri(function (t) {
                        ...
                        for (e = f ? e : r; ++e < r;) {
                            var c = Wi(o = t[e]), l = "wrapper" == c ? Li(o) : i;
                ...
                function pi(n, t, r, u, o, f, a, c, l, s) {
                    var h = t & A, p = t & y, v = t & d, _ = t & (w | m), g = t & k, b = v ? i : li(n);
                    return function y() {
                        for (var d = arguments.length, w = e(d), m = d; m--;) w[m] = arguments[m];
                        if (_) var x = Ci(y), j = function (n, t) {
                ...
                function di(n) {
                    return function (t, r, u) {
                        return u && "number" != typeof u && Ki(t, r, u) && (r = u = i), t = Mf(t), r === i ? (r = t, t = 0) : r = Mf(r), function (n, t, r, u) {
                ...
                function wi(n, t, r, e, u, o, f, a, c, l) {
                    ...
                    var h = [n, t, u, s ? o : i, s ? f : i, s ? i : o, s ? i : f, a, c, l], p = r.apply(i, h);
                ...
                function Ai(n, t, r, u, o, f, c, l) {
                    ...
                    var g = h ? i : Li(n), k = [n, t, r, u, o, v, _, f, c, l];
                    if (g && function (n, t) {
                        var r = n[1], e = t[1], u = r | e, i = u < (y | d | A),
                        ...
                        (f = t[5]) && (a = n[5], n[5] = a ? ti(a, f, t[6]) : f, n[6] = a ? Ir(n[5], s) : t[6]);
                        (f = t[7]) && (n[7] = f);
                    ...
                    }(n, t, r, u); else var E = function (n, t, r) {
                        var e = t & y, u = li(n);
                        return function t() {
                ...
                }, df = e.isArray, bf = Dt ? yr(Dt) : function (n) {
                    return Rf(n) && Qe(n) == cn
                };
                ...
                var xf = Mr || qa, jf = Mt ? yr(Mt) : function (n) {
                    return Rf(n) && Qe(n) == Z
                };
                ...
                var $f = bi(su), Pf = bi(function (n, t) {
                    return n <= t
                });
                ...
                var Vf = ii(function (n, t) {
                    if (Ji(t) || wf(t)) ei(t, ia(t), n); else for (var r in t) st.call(t, r) && Ie(n, r, t[r])
                }), Gf = ii(function (n, t) {
                    ei(t, oa(t), n)
                ...
                var Qf = ju(function (n, t) {
                    ...
                    for (u && Ki(t[0], t[1], u) && (e = 1); ++r < e;) for (var o = t[r], f = oa(o), a = -1, c = f.length; ++a < c;) {
                        var l = f[a], s = n[l];
                ...
                function Ta(n, t, r) {
                    ...
                    var i = !(If(r) && "chain" in r && !r.chain), o = Of(n);
                    return Gt(u, function (r) {
                        var e = t[r];
                        n[r] = e, o && (n.prototype[r] = function () {
                            var t = this.__chain__;
                            if (i || t) {
                                var r = n(this.__wrapped__), u = r.__actions__ = ri(this.__actions__);
                ...
                return pe.after = function (n, t) {
                    ...
                    return (null == n ? 0 : n.length) ? qe(n, t = t === i ? 1 : Ff(t)) : []
                }, pe.flip = function (n) {
                    return Ai(n, k)
                    ...
                    n = Kf(n), t = Uu(t);
                    var e = n.length, u = r = r === i ? e : Ce(Ff(r), 0, e);
                    ...
                    return t = Mf(t), r === i ? (r = t, t = 0) : r = Mf(r), function (n, t, r) {
                    ...
                    var u, o, f = Hf({}, t.imports, e.imports, Oi), a = ia(f), c = dr(f, a), l = 0,
                        s = t.interpolate || Yn, h = "__p += '",
                ...
                }), Ha), {chain: !1}),pe.VERSION = "4.17.15",Gt(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function (n) {
                    pe[n].placeholder = pe
                    ...
                    var r = /^(?:filter|find|map|reject)|While$/.test(t), e = /^(?:head|last)$/.test(t),
                        u = pe[e ? "take" + ("last" == t ? "Right" : "") : t], o = e || /^find/.test(t);
                    u && (pe.prototype[t] = function () {
                        var t = this.__wrapped__, f = e ? [1] : arguments, a = t instanceof ye, c = f[0],
                            l = a || df(t), s = function (n) {
                        ...
                        if (!o && l) {
                            t = _ ? t : new ye(this);
                            var g = n.apply(t, f);
                            return g.__actions__.push({func: Do, args: [s], thisArg: i}), new ge(g, h)
                        }
                    ...
                    if (r) {
                        var e = r.name + "";
                        st.call(ue, e) || (ue[e] = []), ue[e].push({name: t, func: r})
                    }
                }),ue[pi(i, d).name] = [{name: "wrapper", func: i}],ye.prototype.clone = function () {
                    ...
                    var n = this.__wrapped__.value(), t = this.__dir__, r = df(n), e = t < 0, u = r ? n.length : 0,
                        i = function (n, t, r) {
                            var e = -1, u = r.length;
                            for (; ++e < u;) {
                                var i = r[e], o = i.size;
    ...
    document.body.appendChild(((u = document.createElement("div")).innerHTML = o.a.join(["Hello", "webpack"], " "), console.log((e = 12) * e * e), u))
}]);